...
void various_levels_various_lasers_20220915(){
...
//  level[0] = 3400;//for wave5.dat, baseline=3350---
  level[0] = 2570;//for wave6.dat, baseline=2520---
  for(int i=1; i<8; ++i){
...
//======Read No Laser========================
  ifstream fin;
  fin.open("/afs/cern.ch/work/s/shuaixia/public/Coldbox_Data_2022/Sep_Test/light_leakage_check/20220915_v3_laser1_705_laser2_737_laser3_740/xarapuca_V3_cosmic_trigger50_no_laser/wave6.dat", ios::in | ios::binary);
...
//======Read Laser 1========================
  fin.open("/afs/cern.ch/work/s/shuaixia/public/Coldbox_Data_2022/Sep_Test/light_leakage_check/20220915_v3_laser1_705_laser2_737_laser3_740/xarapuca_V3_cosmic_trigger50_laser_1/wave6.dat", ios::in | ios::binary);
...
//======Read Laser 2========================
  fin.open("/afs/cern.ch/work/s/shuaixia/public/Coldbox_Data_2022/Sep_Test/light_leakage_check/20220915_v3_laser1_705_laser2_737_laser3_740/xarapuca_V3_cosmic_trigger50_laser_2/wave6.dat", ios::in | ios::binary);
...
//======Read Laser 3========================
  fin.open("/afs/cern.ch/work/s/shuaixia/public/Coldbox_Data_2022/Sep_Test/light_leakage_check/20220915_v3_laser1_705_laser2_737_laser3_740/xarapuca_V3_cosmic_trigger50_laser_3/wave6.dat", ios::in | ios::binary);
...
//======Read Laser 1 and 2 and 3========================
  fin.open("/afs/cern.ch/work/s/shuaixia/public/Coldbox_Data_2022/Sep_Test/light_leakage_check/20220915_v3_laser1_705_laser2_737_laser3_740/xarapuca_V3_cosmic_trigger50_laser_1_and_2_and_3/wave6.dat", ios::in | ios::binary);
...
//======Drawing absolute counts====================
  ...
  leg->AddEntry(dis0, "No Laser: 2520ADC");
  leg->AddEntry(dis1, "v3 Laser 1 [705mW]");
  leg->AddEntry(dis2, "v3 Laser 2 [737mW]");
  leg->AddEntry(dis3, "v3 Laser 3 [740mW]");
  leg->AddEntry(dis123, "v3 (Laser1+2+3) [2182mW]");
...
//======Draw Gain========================
  ...
  leg2->AddEntry(diff1, "v3 Laser 1 [705mW]");
  leg2->AddEntry(diff2, "v3 Laser 2 [737mW]");
  leg2->AddEntry(diff3, "v3 Laser 3 [740mW]");
  leg2->AddEntry(diff123, "v3 (Laser1+2+3) [2182mW]");
