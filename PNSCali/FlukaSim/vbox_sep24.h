...
// Fixed size dimensions of array or collections stored in the TTree if any.
  ...
  */
  ...
  TH1F* tc=nullptr;
  TH1F* petot=new TH1F("petot","total",50, 100, 2100);
  TH1F* petotC1=new TH1F("petotC1","C1total",50, 100, 2100);
  TH1F* petotC2=new TH1F("petotC2","C2total",50, 100, 2100);
  TH1F* petotC3=new TH1F("petotC3","C3total",50, 100, 2100);
  TH1F* petotC4=new TH1F("petotC4","C4total",50, 100, 2100);
  TH1F* timcap=new TH1F("timcap","capture ",1200,0.,1200.);
  TH1F* pecap=new TH1F("pecap","capture ",50, 100, 2100);
  TH1F* pecapC1=new TH1F("pecapC1","C1capture ",50, 100, 2100);
  TH1F* pecapC2=new TH1F("pecapC2","C2capture ",50, 100, 2100);
  TH1F* pecapC3=new TH1F("pecapC3","C3capture ",50, 100, 2100);
  TH1F* pecapC4=new TH1F("pecapC4","C4capture ",50, 100, 2100);
  TH1F* timine=new TH1F("timine","inelastic ",1200,0.,1200.);
  TH1F* peine=new TH1F("peine","inelastic ",50, 100, 2100);
  TH1F* peineC1=new TH1F("peineC1","C1inelastic ",50, 100, 2100);
  TH1F* peineC2=new TH1F("peineC2","C2inelastic ",50, 100, 2100);
  TH1F* peineC3=new TH1F("peineC3","C3inelastic ",50, 100, 2100);
  TH1F* peineC4=new TH1F("peineC4","C4inelastic ",50, 100, 2100);
  TH1F* timoth=new TH1F("timoth","no neutron int in activeLAr",1200,0.,1200.);
  TH1F* peoth=new TH1F("peoth","no neutron int in activeLAr", 50, 100, 2100);
  TH1F* peothC1=new TH1F("peothC1","C1 no neutron int in activeLAr", 50, 100, 2100);
  TH1F* peothC2=new TH1F("peothC2","C2 no neutron int in activeLAr", 50, 100, 2100);
  TH1F* peothC3=new TH1F("peothC3","C3 no neutron int in activeLAr", 50, 100, 2100);
  TH1F* peothC4=new TH1F("peothC4","C4 no neutron int in activeLAr", 50, 100, 2100);
